...
from .views import GamePerformanceUpdateView, GamePredictionView, GameSessionCreateView, RoomPlayersView, CreateRoomPlayerView, CreateRoomView, UpdatePlayerInfoView, RoomStartView
...
urlpatterns = [
    ...
    path('room/start', RoomStartView.as_view(), name='room-start'),
